...
CFLAGS	=\
$(OPTIM) $(VAR) $(GPOPT) $(DEBUG) $(ASSERT) $(EXCEPT) \
-ffreestanding -ffunction-sections -minterlink-mips16 -mcode-xonly -Werror \
-D_SUPPRESS_PLIB_WARNING -D_DISABLE_OPENADC10_CONFIGPORT_WARNING -D_DISABLE_OPENADC10_CONFIGSCAN_WARNING

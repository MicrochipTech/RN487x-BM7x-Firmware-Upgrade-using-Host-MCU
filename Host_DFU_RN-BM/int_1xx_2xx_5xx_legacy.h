...
// ISR Priority - Single interrupt vector for all CNx => single ISR
...
#ifdef _SPI3
 //SPI 3 Error
  #define mSPI3EClearIntFlag()                 (IFS2CLR = _IFS2_SPI3EIF_MASK)
  #define mSPI3EGetIntFlag()                   (IFS2bits.SPI3EIF)
  #define mSPI3EGetIntEnable()                 (IEC2bits.SPI3EIE)
  #define mSPI3EIntEnable(enable)              (IEC2CLR = _IEC2_SPI3EIE_MASK, IEC2SET = ((enable) << _IEC2_SPI3EIE_POSITION))

 //SPI 3 Transfer
  #define mSPI3TXClearIntFlag()                (IFS2CLR = _IFS2_SPI3TXIF_MASK)
  #define mSPI3TXGetIntFlag()                  (IFS2bits.SPI3TXIF)
  #define mSPI3TXGetIntEnable()                (IEC2bits.SPI3TXIE)
  #define mSPI3TXIntEnable(enable)             (IEC2CLR = _IEC2_SPI3TXIE_MASK, IEC2SET = ((enable) << _IEC2_SPI3TXIE_POSITION))

 // SPI 3 Receive
  #define mSPI3RXClearIntFlag()                (IFS2CLR = _IFS2_SPI3RXIF_MASK)
  #define mSPI3RXGetIntFlag()                  (IFS2bits.SPI3RXIF)
  #define mSPI3RXGetIntEnable()                (IEC2bits.SPI3RXIE)
  #define mSPI3RXIntEnable(enable)             (IEC2CLR = _IEC2_SPI3RXIE_MASK, IEC2SET = ((enable) << _IEC2_SPI3RXIE_POSITION))

 //SPI 3 Vector
  #define mSPI3ClearAllIntFlags()              (IFS2CLR = (_IFS2_SPI3EIF_MASK | _IFS2_SPI3TXIF_MASK | _IFS2_SPI3RXIF_MASK))
  #define mSPI3IntDisable()                    (IEC2CLR = (_IEC2_SPI3EIE_MASK | _IEC2_SPI3TXIE_MASK | _IEC2_SPI3RXIE_MASK))
  #define mSPI3SetIntEnable(flags)             (IEC2SET = (((flags) & 0x7) << _IEC2_SPI3EIE_POSITION))
  #define mSPI3SetIntPriority(priority)        (IPC12CLR = _IPC12_SPI3IP_MASK, IPC12SET = ((priority) << _IPC12_SPI3IP_POSITION))
  #define mSPI3GetIntPriority()                (IPC12bits.SPI3IP)
  #define mSPI3SetIntSubPriority(subPriority)  (IPC12CLR = _IPC12_SPI3IS_MASK, IPC12SET = ((subPriority) << _IPC12_SPI3IS_POSITION))
  #define mSPI3GetIntSubPriority()             (IPC12bits.SPI3IS)
...
#ifdef _SPI4
 //SPI 4 Error
  #define mSPI4EClearIntFlag()                 (IFS2CLR = _IFS2_SPI4EIF_MASK)
  #define mSPI4EGetIntFlag()                   (IFS2bits.SPI4EIF)
  #define mSPI4EGetIntEnable()                 (IEC2bits.SPI4EIE)
  #define mSPI4EIntEnable(enable)              (IEC2CLR = _IEC2_SPI4EIE_MASK, IEC2SET = ((enable) << _IEC2_SPI4EIE_POSITION))

 //SPI 4 Transfer
  #define mSPI4TXClearIntFlag()                (IFS2CLR = _IFS2_SPI4TXIF_MASK)
  #define mSPI4TXGetIntFlag()                  (IFS2bits.SPI4TXIF)
  #define mSPI4TXGetIntEnable()                (IEC2bits.SPI4TXIE)
  #define mSPI4TXIntEnable(enable)             (IEC2CLR = _IEC2_SPI4TXIE_MASK, IEC2SET = ((enable) << _IEC2_SPI4TXIE_POSITION))

 // SPI 4 Receive
  #define mSPI4RXClearIntFlag()                (IFS2CLR = _IFS2_SPI4RXIF_MASK)
  #define mSPI4RXGetIntFlag()                  (IFS2bits.SPI4RXIF)
  #define mSPI4RXGetIntEnable()                (IEC2bits.SPI4RXIE)
  #define mSPI4RXIntEnable(enable)             (IEC2CLR = _IEC2_SPI4RXIE_MASK, IEC2SET = ((enable) << _IEC2_SPI4RXIE_POSITION))

 //SPI 4 Vector
  #define mSPI4ClearAllIntFlags()              (IFS2CLR = (_IFS2_SPI4EIF_MASK | _IFS2_SPI4TXIF_MASK | _IFS2_SPI4RXIF_MASK))
  #define mSPI4IntDisable()                    (IEC2CLR = (_IEC2_SPI4EIE_MASK | _IEC2_SPI4TXIE_MASK | _IEC2_SPI4RXIE_MASK))
  #define mSPI4SetIntEnable(flags)             (IEC2SET = (((flags) & 0x7) << _IEC2_SPI4EIE_POSITION))
  #define mSPI4SetIntPriority(priority)        (IPC12CLR = _IPC12_SPI4IP_MASK, IPC12SET = ((priority) << _IPC12_SPI4IP_POSITION))
  #define mSPI4GetIntPriority()                (IPC12bits.SPI4IP)
  #define mSPI4SetIntSubPriority(subPriority)  (IPC12CLR = _IPC12_SPI4IS_MASK, IPC12SET = ((subPriority) << _IPC12_SPI4IS_POSITION))
  #define mSPI4GetIntSubPriority()             (IPC12bits.SPI4IS)
...
/**********************************************
  * Comparator 3 Interrupt Control Functions
  **********************************************/
  #define mCMP3ClearIntFlag()                     (IFS2CLR = _IFS2_CMP3IF_MASK)
  #define mCMP3GetIntFlag()                       (IFS2bits.CMP3IF)
  #define mCMP3GetIntEnable()                     (IEC2bits.CMP3IE)
  #define mCMP3IntEnable(enable)                  (IEC2CLR = _IEC2_CMP3IE_MASK, IEC2SET = ((enable) << _IEC2_CMP3IE_POSITION))
  #define mCMP3SetIntPriority(priority)           (IPC11CLR = _IPC11_CMP3IP_MASK, IPC11SET = ((priority) << _IPC11_CMP3IP_POSITION))
  #define mCMP3GetIntPriority()                   (IPC11bits.CMP3IP)
  #define mCMP3SetIntSubPriority(subPriority)     (IPC11CLR = _IPC11_CMP3IS_MASK, IPC11SET = ((subPriority) << _IPC11_CMP3IS_POSITION))
  #define mCMP3GetIntSubPriority()                (IPC11bits.CMP3IS)
 ...
 ********************************************************************/
#ifdef _CAN1
  #define mCAN1ClearIntFlag()                 (IFS2CLR = _IFS2_CAN1IF_MASK)
  #define mCAN1GetIntFlag()                   (IFS2bits.CAN1IF)
  #define mCAN1GetIntEnable()                 (IEC2bits.CAN1IE)
  #define mCAN1IntEnable(enable)              (IEC2CLR = _IEC2_CAN1IE_MASK, IEC2SET = ((enable) << _IEC2_CAN1IE_POSITION))
